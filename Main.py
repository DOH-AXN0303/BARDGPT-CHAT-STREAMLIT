...
if 'welcome' not in st.session_state or lang != st.session_state.lang:
    ...
    Give a short friendly welcome greeting to the user and suggest what they can do (You can describe images, answer questions, read text files, and read tables). Introduce yourself. generate the answer in {lang}''')
    welcome.resolve()
